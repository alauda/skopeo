...
local-cross: bin/skopeo.darwin.arm64 bin/skopeo.darwin.amd64 bin/skopeo.linux.amd64 bin/skopeo.linux.arm64 bin/skopeo.windows.386.exe bin/skopeo.windows.amd64.exe
